...
setFrontendImage(URL.createObjectURL(file))
  ...
  return (
    <div className='w-full h-[100vh] bg-gradient-to-t from-[#000000] to-[#6d28d9] flex justify-center items-center flex-col p-[20px] '>
        <MdKeyboardBackspace className='absolute top-[30px] left-[30px] text-white cursor-pointer w-[25px] h-[25px]' onClick={()=>navigate("/")}/>
        <h1 className='text-white mb-[40px] text-[30px] text-center '>Select your <span className='text-teal-200'>Assistant Image</span></h1>
